...
def insertFromSimpleOSM(conn, whereTime={}, loglevel=0):
  ...
  #print("отладка:","limitNode['min']=",limitNode['min'])
  #print("отладка:","limitNode['max']=", limitNode['max'])
  #print("отладка:","limitNode['max']+1=", limitNode['max']+1)
  #print("отладка:","conf.nodeStep=",conf.nodeStep)
